...
class CreateRefereeForm extends StatefulWidget {
  const CreateRefereeForm({super.key});

  @override
  State<CreateRefereeForm> createState() => _CreateRefereeFormState();
}

class _CreateRefereeFormState extends State<CreateRefereeForm> {
  ...
  void _submit() {
    ...
    context.read<UserCreationCubit>().registerReferee(
